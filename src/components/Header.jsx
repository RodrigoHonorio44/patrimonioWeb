    ...
    <header className="h-24 bg-white/70 backdrop-blur-xl border-b border-slate-100 flex items-center justify-between px-10 sticky top-0 z-50">
      ...
      >
        <div className="flex items-center gap-2 mb-1">
          ...
          <h2 className="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em] group-hover:tracking-[0.4em] transition-all">
            Rodhon System
          </h2>
        </div>
      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-4 group">
          <div className="text-right hidden md:block">
            ...
            {/* Nome e Sobrenome */}
            <p className="text-sm font-black text-slate-800 uppercase italic group-hover:text-blue-600 transition-colors">
