    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8 font-sans">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="bg-white border border-slate-200 text-slate-600 px-4 py-2.5 rounded-xl flex items-center gap-2 text-sm font-bold hover:bg-slate-50 transition-all"
            >
      ...
      <div className="max-w-7xl mx-auto bg-white p-6 rounded-3xl shadow-sm border border-slate-100 mb-8 grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
        ...
        <button
          ...
          className="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-100"
        >
          {loading ? (
                      ...
                      <td className="p-4 text-center">
                        {item.status === "Ativo" ? (
                          <button
                            ...
                            className="bg-red-50 text-red-500 hover:bg-red-500 hover:text-white px-3 py-1.5 rounded-lg text-xs font-bold transition-all shadow-sm"
                          >
                            Baixar
                          </button>
                        ) : (
      ...
      {modalBaixa.aberto && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in duration-200">
            ...
            <p className="text-slate-500 text-center mb-8 text-sm italic">
              Item: {modalBaixa.nome}
            </p>
            <div className="flex gap-3">
              <button
                onClick={() => setModalBaixa({ aberto: false })}
                className="flex-1 bg-slate-100 py-3 rounded-2xl font-bold text-slate-600"
              >
                Sair
              </button>
              <button
                onClick={confirmarBaixa}
                className="flex-1 bg-red-600 text-white py-3 rounded-2xl font-bold shadow-lg shadow-red-200"
              >
                Confirmar
              </button>
            </div>
